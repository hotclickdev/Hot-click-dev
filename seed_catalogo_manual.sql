-- =============================================================
-- SEED MANUAL: 7 categorías padre + 14 subcategorías + 40 productos
-- Pegar en Supabase SQL Editor y ejecutar todo de una vez.
-- Tablas y columnas en lowercase (como están en la BD real).
-- =============================================================
...
SELECT COUNT(*) AS total_categorias_nuevas
FROM hot_click_categoria_tb
WHERE nombre_categoria IN (
    'Electrónica y Gadgets','Moda y Estilo','Hogar y Decoración',
    'Deporte y Aventura','Belleza Natural','Mascotas y Amigos','Juguetes y Entretenimiento',
    'Celulares y Tablets','Audio y Video','Ropa Casual','Calzado y Bolsos',
    'Sala y Comedor','Dormitorio','Gym y Fitness','Aire Libre',
    'Skincare','Cabello y Cuerpo','Para Perros','Para Gatos',
    'Juguetes Educativos','Gaming'
);

SELECT COUNT(*) AS total_productos_nuevos
