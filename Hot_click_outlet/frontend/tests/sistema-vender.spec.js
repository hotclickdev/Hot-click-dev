...
import { getAvailableModes, puedeUsarCaja } from '../src/utils/modes.js'
import { construirPasosChecklist, debeMostrarChecklist } from '../src/pages/admin/sistema-inicio/sistemaChecklistPasos.js'
...
function payloadAuth({ rol, permissions = [] }) {
  return {
    state: {
...
async function sesionEmprendedor(page, opts) {
