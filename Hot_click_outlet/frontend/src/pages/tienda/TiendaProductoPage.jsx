...
export default function TiendaProductoPage() {
  ...
  const imagenes = [producto.imagenUrl, ...(producto.imagenesAdicionales ?? [])].filter(Boolean)
...
function GaleriaProducto({ imagenes, imgActiva, onElegir, nombre }) {
  return (
...
function InfoProducto({ producto, stockDisponible, cantidad, setCantidad, agregado, onAgregar, onComprarAhora, slug }) {
  return (
