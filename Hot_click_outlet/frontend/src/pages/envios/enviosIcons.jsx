...
export function IconEncomienda() {
  return (
    <svg width="26" height="26" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
...
export function IconInternacional() {
  return (
    <svg width="26" height="26" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
...
export function IconBadgeOfficial() {
  return (
...
export function IconUrgentBolt() {
  return (
