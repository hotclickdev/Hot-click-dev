        ...
        >
          <button type="button"
            ...
            style={{
              ...
              boxShadow: '0 8px 32px color-mix(in srgb, var(--hc-primary) 45%, transparent), 0 2px 8px rgba(0,0,0,0.3)',
            }}
          >
            <div className="relative">
              ...
              <span className="absolute -top-1.5 -right-1.5 w-4 h-4 rounded-full bg-white text-[9px] font-bold flex items-center justify-center" style={{ color: 'var(--hc-primary)' }}>
                {items.length}
              </span>
            </div>
            <div className="text-left">
              <p className="text-xs font-bold text-white leading-none">{t('cart.viewPedido')}</p>
