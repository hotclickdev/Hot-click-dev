  ...
  return (
    <div className="relative overflow-hidden py-10 px-4"
      ...
      <div className="max-w-7xl mx-auto">
        {activeCatName && (
          <nav aria-label={t('a11y.breadcrumb')} className="flex items-center gap-2 text-xs mb-4">
            ...
            <button type="button" onClick={onClearCategory} className="hover:underline" style={{ color: 'var(--hc-muted)' }}>{t('nav.productos')}</button>
            <span aria-hidden="true" style={{ color: 'var(--hc-border-strong)' }}>/</span>
        ...
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            <h1 className="text-4xl sm:text-5xl font-black tracking-tight" style={{ color: 'var(--hc-text)' }}>
              {activeCatName ?? t('products.fullCatalog')}
            </h1>
        ...
        <div className="flex items-center gap-2 mt-3">
          ...
          <span className="text-xs font-semibold" style={{ color: 'var(--hc-muted)' }}>
            {t('products.availableCount', { count: filteredCount })}
          </span>
        </div>
      </div>
