...
function authDataRegistro(data: unknown): (AuthResponse & { otpEnviado?: boolean }) | undefined {
  if (!data || typeof data !== 'object') return undefined
  const envelope = data as { data?: AuthResponse & { otpEnviado?: boolean }; accessToken?: string }
  return envelope.data ?? (envelope.accessToken ? envelope as AuthResponse & { otpEnviado?: boolean } : undefined)
}

export default function EmprendimientoForm({ onVolver }: { onVolver: () => void }) {
