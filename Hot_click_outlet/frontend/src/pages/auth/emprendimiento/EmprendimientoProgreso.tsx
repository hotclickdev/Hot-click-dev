 ...
 */
export default function EmprendimientoProgreso({ step }: { step: number }) {
  return (
...
function estiloPasoEmprendimiento(i: number, step: number): { background: string; color: string; boxShadow?: string; border?: string } {
