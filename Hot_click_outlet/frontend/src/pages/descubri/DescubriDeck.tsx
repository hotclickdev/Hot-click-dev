...
import type { DescubriDeckApi, DirSwipeDescubri } from './destinoDetalleDescubri'

/** Mazo de cartas (hasta 3 visibles) y controles. */
export default function DescubriDeck({
  deck,
  lastDir,
  onSwipe,
  onUndo,
  ...
  deck: DescubriDeckApi
  lastDir: DirSwipeDescubri
