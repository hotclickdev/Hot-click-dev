...
function CabeceraPedido({ esEfectivo }) {
  return (
...
function BloqueEfectivo({ pagoData, totalFinal, onSinpeWhatsApp }) {
  return (
...
function ComprobanteListo({ onSinpeWhatsApp }) {
  return (
    <motion.div
...
function WhatsAppAtajo({ onClick, children }) {
  return (
    <button
      type="button"
      onClick={onClick}
...
function LinkMisPedidos({ primario = false }) {
  if (primario) {
    return (
