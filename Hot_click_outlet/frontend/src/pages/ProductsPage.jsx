...
export default function ProductsPage() {
  ...
  const {
    ...
    aiPanelOpen, setAiPanelOpen, aiQuery,
    clearFilters, filtered, hasFilters, activeCatName, selectCategoryFromAi,
  } = catalogo
  ...
  return (
    <>
      ...
      <CatalogAiFab aiPanelOpen={aiPanelOpen} setAiPanelOpen={setAiPanelOpen} />
