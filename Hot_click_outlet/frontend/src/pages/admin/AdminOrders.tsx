...
export default function AdminOrders() {
  ...
  const [filter, setFilter] = useStickyState<string>('hc-ord-filter', 'Todos')
  ...
  const handleUpdate = (id: Id, fields: Partial<Pedido>) =>
  ...
  const handleCreated = (newOrder: unknown) => {
    ...
    if (pedido?.id) { setOrders((prev) => [pedido, ...prev]); return }
    setLoading(true)
    load()
  }
