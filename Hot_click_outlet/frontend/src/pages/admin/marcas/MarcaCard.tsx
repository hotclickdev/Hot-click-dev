import { inicialDeMarca, type MarcaAdmin } from './formMarca'
...
function LogoMarca({ marca, logoRoto, onLogoError }: { marca: MarcaAdmin; logoRoto: boolean; onLogoError: () => void }) {
