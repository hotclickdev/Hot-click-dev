...
/* ── Selector / alta rápida de cliente ─────────────── */
function ClienteSelector({ cliente, onChange }) {
      ...
      <button onClick={() => setOpen(o => !o)}
        ...
        {cliente && (
          <span onClick={(e) => { e.stopPropagation(); onChange(null) }}
            className="text-xs shrink-0 opacity-60 hover:opacity-100">✕</span>
        )}
      </button>
...
/* ── PASO 2: Venta ─────────────────────────────────── */
function StepVenta({ cartItems, onAdd, onSetCantidad, onSetPrecio, onRemove, descuento, onSetDescuento, subtotal, total, onNueva, onCobrar, onQrCliente, loadingQr, cliente, onSetCliente }) {
