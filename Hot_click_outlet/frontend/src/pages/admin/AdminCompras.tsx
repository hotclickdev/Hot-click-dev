...
import type { FiltroCompras, OrdenCompra } from './compras/comprasHelpers'
...
export default function AdminCompras() {
  ...
  const load = useCallback(() => {
    ...
    compraService.listar()
      .then((data: unknown) => setOrdenes(Array.isArray(data) ? data as OrdenCompra[] : []))
      .catch((err: unknown) => { void err; showToast('Error al cargar órdenes', 'error') })
