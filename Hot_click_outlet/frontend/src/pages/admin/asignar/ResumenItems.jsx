...
import { totalItems } from './asignarHelpers'

/**
 * @param {{ items: { productoId: number, nombre: string, imagenUrl?: string, cantidad: number, precioUnitario: number }[] }} props
 */
export default function ResumenItems({ items }) {
  return (
