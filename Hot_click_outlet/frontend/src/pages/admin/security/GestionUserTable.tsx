...
function EstadoBadgeGestion({ estado }: { estado: string }) {
...
export default function GestionUserTable({
  ...
  loading: boolean
  filtered: GestionUser[]
  empresaByCorreo: Record<string, GestionEmpresa>
  secByCorreo: Record<string, SecurityUsuario>
  expanded: Id | null
  onToggleExpand: (id: Id | null) => void
  onEdit: (u: GestionUser) => void
  onAction: (u: GestionUser, type: GestionActionType) => void
}) {
  if (loading) {
