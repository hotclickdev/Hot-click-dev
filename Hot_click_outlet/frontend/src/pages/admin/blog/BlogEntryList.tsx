...
import { fmtDate, type BlogForm } from './blogHelpers'
import CloseIcon from '@/components/ui/CloseIcon'
import type { Id } from '@/types/api'

export type BlogEntryListProps = {
  lista: BlogForm[]
  onTogglePublicado: (e: BlogForm) => void
  onEdit: (e: BlogForm) => void
  onDelete: (id?: Id) => void
}

export default function BlogEntryList({ lista, onTogglePublicado, onEdit, onDelete }: BlogEntryListProps) {
  return (
