...
export const INSPECT_WORKFLOW_URL =
  `${GITHUB}/actions/workflows/inspect-agents.yml`
...
export function githubIssuesUrl(query: string): string {
  return `${GITHUB}/issues?q=${encodeURIComponent(query)}`
}
