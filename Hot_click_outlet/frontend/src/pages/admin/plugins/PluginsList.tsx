...
import type { PluginAdmin } from './pluginsHelpers'
...
export default function PluginsList({
  ...
  plugins: PluginAdmin[]
  testOk: Id | null
  onTestWebhook: (p: PluginAdmin) => void
  onShowLogs: (p: PluginAdmin) => void
  onEdit: (p: PluginAdmin) => void
  onDeactivate: (p: PluginAdmin) => void
}) {
  return (
