...
import { FONTS_BRANDING, type BrandingFormulario } from './brandingHelpers'

export type BrandingFormProps = {
  form: BrandingFormulario
  set: (key: keyof BrandingFormulario) => (val: string) => void
  error: string | null
  guardando: boolean
  ok: boolean
}

export default function BrandingForm({ form, set, error, guardando, ok }: BrandingFormProps) {
  return (
