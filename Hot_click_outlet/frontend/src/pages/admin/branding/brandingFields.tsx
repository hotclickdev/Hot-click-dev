...
export function TextField({ label, value, onChange, placeholder, multiline, fieldId }: {
  ...
  const className = 'w-full px-3 py-2 rounded-xl text-sm outline-none resize-none'
  const style = { backgroundColor: 'var(--hc-bg)', border: '1px solid var(--hc-border)', color: 'var(--hc-text)' }
  return (
    <div className="space-y-1.5">
