...
const QUICK_LABEL = { 7: '7 días', 30: '30 días', 90: '90 días', '-1': 'Todo' }
...
export default function AdminReporteContador() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      if (err?.response?.status === 403) showToast('Tu plan no incluye este reporte. Mejora tu plan para exportarlo.', 'error')
