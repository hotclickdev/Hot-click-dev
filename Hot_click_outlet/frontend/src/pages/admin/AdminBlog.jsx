...
export default function AdminBlog() {
  ...
  useEffect(() => {
    ventaService.getAll()
      .then(({ data }) => {
        const ventas = Array.isArray(data) ? data : data?.content ?? []
        setSugerido(postSugeridoDeVentas(ventas))
      })
      .catch((err) => console.error('[AdminBlog] top producto', err))
  }, [])
...
function BannerPostSugerido({ producto, onPublicar }) {
  return (
    <div style={{
