...
function BadgeConContenido({ visible }: { visible: boolean }) {
...
function etiquetaVideo(url: string | null | undefined) {
  if (!url) return null
...
export default function BloqueContenido({ form, setForm }: BloqueFormProps) {
