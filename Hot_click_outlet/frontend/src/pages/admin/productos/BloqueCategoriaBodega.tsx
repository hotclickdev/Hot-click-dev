...
import type { BloqueFormProps } from './BloquePrecios'
import type { BodegaAdmin, CategoriaAdmin } from './productosHelpers'

export type BloqueCategoriaBodegaProps = BloqueFormProps & {
  categories: CategoriaAdmin[]
  bodegas: BodegaAdmin[]
}

export default function BloqueCategoriaBodega({ form, setForm, categories, bodegas }: BloqueCategoriaBodegaProps) {
  return (
    <div className="grid grid-cols-2 gap-3">
      <div className="flex flex-col gap-1.5">
        ...
        <CategoriaSelect
          ...
          onChange={(id: string) => setField(setForm, 'categoriaId', id)}
          required
        />
      </div>
      <div className="flex flex-col gap-1.5">
