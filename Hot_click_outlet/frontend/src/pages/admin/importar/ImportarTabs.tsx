...
import type { ImportarTabId } from './importarHelpers'
import { IconCsv, IconGlobe, IconPdf, IconSpinner, IconUpload } from './importarIcons'
import type { ChangeEvent, Dispatch, DragEvent, KeyboardEvent, ReactElement, RefObject, SetStateAction } from 'react'

const ICONOS_TAB: Record<ImportarTabId, ReactElement> = {
  url: <IconGlobe />,
  pdf: <IconPdf />,
  csv: <IconCsv />,
}
      ...
      {(tab === 'pdf' || tab === 'csv') && (
        <button
          ...
          <input ref={fileRef} type="file" className="hidden"
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) => setArchivoState(e.target.files?.[0] || null)}
