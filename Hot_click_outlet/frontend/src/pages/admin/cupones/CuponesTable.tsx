import { FILTERS, fmt, PAGE_SIZE, type CuponAdmin, type CuponesStats, type FiltroCupon } from './cuponesHelpers'
import { Badge, StatCard, UsageBar } from './CuponesUi'
import TextoFlecha from '@/components/ui/TextoFlecha'

type CuponesTableProps = {
  stats: CuponesStats | null
  filter: FiltroCupon
  search: string
  loading: boolean
  visible: CuponAdmin[]
  page: number
  total: number
  onApplyFilter: (val: FiltroCupon) => void
