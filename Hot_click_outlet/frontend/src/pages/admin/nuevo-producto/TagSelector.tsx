...
type IconoTag = ComponentType<SVGProps<SVGSVGElement>>

const TAG_ICONS: Record<string, IconoTag> = {
...
export default function TagSelector({ value, onChange }: { value: string; onChange: (v: string) => void }) {
