...
import type { EmpresaPedidoTab } from './empresasHelpers'

function PedidoRow({ pedido }: { pedido: EmpresaPedidoTab }) {
  return (
...
export default function TabPedidos({ loading, pedidos }: { loading: boolean; pedidos: EmpresaPedidoTab[] | null }) {
