...
const SEG_COLORS: Record<string, string> = { NUEVO: '#6490EA', FRECUENTE: '#34d399', VIP: '#fbbf24', INACTIVO: '#A7B0BC' }

export type CrmTabProps = {
  clientes: ClienteCrm[]
  crmSearch: string
...
export default function CrmTab({ clientes, crmSearch, onCrmSearch, onSelect, loading }: CrmTabProps) {
  if (loading) {
    return (
...
function CrmRow({ cliente, onSelect }: { cliente: ClienteCrm; onSelect: (id: Id) => void }) {
