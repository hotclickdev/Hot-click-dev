...
export default function SeccionNotificaciones({ toast, soloVentas = false }: { toast: ToastFn; soloVentas?: boolean }) {
  const { t } = useTranslation()
  const [prefs, setPrefs] = useState<NotifPrefs>(() => {
    try { return { ...defaultNotifPrefs, ...JSON.parse(localStorage.getItem(NOTIF_KEY) || '{}') as Partial<NotifPrefs> } }
  ...
  const allItems: { key: NotifKey; icon: typeof ShoppingIcon; titleKey: string; descKey: string }[] = [
