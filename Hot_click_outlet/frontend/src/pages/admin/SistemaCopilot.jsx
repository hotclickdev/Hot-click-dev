...
export default function SistemaCopilot() {
  ...
  const deshabilitado = chat.enviando || (chat.uso && !chat.uso.habilitado)
...
function SistemaCopilotHeader({ uso, onLimpiar }) {
  return (
...
function SistemaBurbuja({ rol, contenido, streaming }) {
