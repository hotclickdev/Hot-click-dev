...
import { useAdminPagosData } from './useAdminPagosData'
...
export default function PagosTabs({
  ...
  pagosState: ReturnType<typeof useAdminPagosData>
  handleConfirmarSinpe: (pagoId: Id) => void
  handleRechazarSinpe: (pagoId: Id) => void
  handleAprobarComprobante: (id: Id) => void
}) {
  const {
    t,
    tab,
