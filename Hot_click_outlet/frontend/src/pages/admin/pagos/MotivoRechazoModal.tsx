  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      ...
      >
        ...
        <p className="text-xs text-hc-muted">Indicá el motivo (opcional). Se notificará al cliente por correo.</p>
        <textarea
          value={motivoTexto}
          ...
          style={{ background: 'rgba(255,255,255,0.05)', border: '1.5px solid rgba(255,255,255,0.1)', color: 'var(--hc-text)' }}
        />
        <div className="flex gap-2">
          <button type="button"
            onClick={onCancel}
            className="flex-1 py-2.5 rounded-xl text-sm border text-hc-muted hover:text-hc-text transition-colors"
