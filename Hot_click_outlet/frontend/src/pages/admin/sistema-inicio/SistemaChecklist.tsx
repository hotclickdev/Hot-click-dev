...
import { construirPasosChecklist, type PasoChecklist } from './sistemaChecklistPasos'
...
function textoAyuda(pendientes: number) {
...
function PasoLink({ paso, indice }: { paso: PasoChecklist; indice: number }) {
  if (paso.hecho) {
    return (
      <span
...
function NumeroPaso({ hecho, indice, primario }: { hecho: boolean; indice: number; primario: boolean }) {
...
function estiloNumero(hecho: boolean, primario: boolean) {
