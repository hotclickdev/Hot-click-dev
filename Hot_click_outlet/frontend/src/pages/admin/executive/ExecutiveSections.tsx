...
export type CategoriaExecutive = {
  categoria?: string
  ingresos?: number | string
}
...
export type ExecutiveDashboard = {
  ...
  topCategorias?: CategoriaExecutive[]
...
export function TrendBar({ data }: { data: TendenciaMes[] }) {
...
export function ExecutiveKpis({ data }: { data: ExecutiveDashboard | null }) {
  return (
