...
import { SUCCESS, WARNING, DANGER, cardStyle, type ProductoReporte } from './reportesHelpers'

type InventarioTabProps = {
  loading: boolean
  productos: ProductoReporte[]
  stockRiesgo: ProductoReporte[]
}

export default function InventarioTab({ loading, productos, stockRiesgo }: InventarioTabProps) {
