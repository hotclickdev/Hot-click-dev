...
import { fmt, SUCCESS, WARNING, DANGER, INFO, cardStyle, type TopProductoReporte } from './reportesHelpers'
...
export default function ProductosTab({ loading, topProductos }: ProductosTabProps) {
...
function colorMargenProducto(margen: string) {
