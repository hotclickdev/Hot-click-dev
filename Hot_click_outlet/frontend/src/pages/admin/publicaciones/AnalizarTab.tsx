...
import type { ModoAnalisis, ProductoPublicacion, ResultadoVision } from './publicacionesHelpers'

const MODOS_ANALISIS: { key: ModoAnalisis; label: string }[] = [
  { key: 'nombre', label: 'Por nombre' },
  { key: 'foto', label: 'Por foto (Vision API)' },
]

type AnalizarTabProps = {
  modoAnalisis: ModoAnalisis
  onModoAnalisis: (key: ModoAnalisis) => void
  nombreBusqueda: string
  onNombreBusqueda: (value: string) => void
  productoId: string
  onProductoId: (value: string) => void
