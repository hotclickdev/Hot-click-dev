 ...
 */
type VarianteAcceso = 'fila' | 'enlace' | 'muted'

export default function AccesoTiendaPublica({ variante = 'fila', conCopiar = true }: { variante?: VarianteAcceso; conCopiar?: boolean }) {
...
function LinksPublicos({ ruta, variante, conCopiar }: { ruta: string; variante: VarianteAcceso; conCopiar: boolean }) {
  return (
    <>
...
function LinkPublicar({ variante }: { variante: VarianteAcceso }) {
  return (
...
function claseLink(variante: VarianteAcceso) {
  if (variante === 'fila') {
...
function estiloMuted(variante: VarianteAcceso) {
