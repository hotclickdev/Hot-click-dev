...
import { textoPrecioProducto, esProductoCotizable, tieneOfertaActiva } from '@/utils/precioProducto'
      ...
      <div className="flex items-end justify-between gap-2">
        <div className="flex flex-col gap-0.5 min-w-0">
          <div className="flex items-baseline gap-2 flex-wrap">
            ...
            {enOferta && (
              <span className="text-xs line-through" style={{ color: 'var(--hc-muted)' }}>
          ...
          {enOferta && (
            <span
              className="text-[10px] font-extrabold uppercase tracking-wider w-fit px-1.5 py-0.5 rounded"
              style={{ background: 'var(--hc-red-500)', color: '#fff' }}
            >
