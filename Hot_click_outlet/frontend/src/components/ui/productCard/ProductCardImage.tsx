...
const CONDICION_DEFAULT: CSSProperties = { background: 'var(--hc-warning-bg)', color: 'var(--hc-warning)', border: '1px solid color-mix(in srgb, var(--hc-warning) 30%, transparent)' }
...
function HeartCardIcon({ filled }: { filled: boolean }) {
  return filled ? (
