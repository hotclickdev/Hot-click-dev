...
export default function QuickViewInfo({ product, inStock, onClose, children }: QuickViewInfoProps) {
      ...
      <div className="flex-1 p-5 md:p-6 flex flex-col gap-3.5 overflow-y-auto">
        <div className="flex items-start gap-3">
          <div className="flex-1 space-y-1.5">
            {product.condicion && (
              <Badge variant={conditionVariant(product.condicion) as BadgeProps['variant']}>
