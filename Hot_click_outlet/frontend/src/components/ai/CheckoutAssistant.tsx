...
import type { CheckoutAssistantProps } from './checkoutAssistant/checkoutAssistantHelpers'

export default function CheckoutAssistant(props: CheckoutAssistantProps) {
  const {
    mensajes,
    input,
    setInput,
