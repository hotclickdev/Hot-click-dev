...
export default function AIProductCard({
  ...
  const availableBtnStyle = producto.stock === 0 && !encargo
      ...
      <div className="px-3 pb-3">
        {encargo ? (
          <Link
            ...
            className="w-full py-2.5 rounded-xl text-xs font-bold transition-all active:scale-95 inline-flex items-center justify-center"
            style={{ background: '#E73B33', color: '#fff', border: 'none' }}
          >
            Pedir cotización
          </Link>
        ) : (
