export type DatosUsuarioCheckout = {
  nombre?: string
  telefono?: string
  direccion?: string
}

export type CheckoutAssistantProps = {
  tipo: string
  numeroPedido?: string
  metodoPago?: string
  errorCode?: string
  usuarioDatos?: DatosUsuarioCheckout
}

export type MensajeAsistenteCheckout = {
  rol: 'user' | 'assistant'
  texto?: string
  typing?: boolean
  productos?: unknown[]
...
export function clasificarError(code?: string | null) {
