...
type UseAiChatEffectsArgs = {
  ...
  autoSent: MutableRefObject<boolean>
  enviarDirecto: (msg?: string) => Promise<void>
  proactiveTrigger: boolean
  proactiveSent: boolean
  setProactiveSent: Dispatch<SetStateAction<boolean>>
  userName: string | null
  setMensajes: Dispatch<SetStateAction<AiChatMensaje[]>>
  cargRef: MutableRefObject<boolean>
  exitIntentEnabled: boolean
  exitShown: boolean
  setExitShown: Dispatch<SetStateAction<boolean>>
}
