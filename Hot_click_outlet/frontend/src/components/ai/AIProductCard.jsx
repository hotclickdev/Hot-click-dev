...
export default function AIProductCard({ producto, similarity, onAdd, whatsappNumber = '50686667888' }) {
  ...
  function buildWhatsAppLink() {
    const url = `${window.location.origin}/productos/${producto.id}`
    const text = encodeURIComponent(`Hola, me interesa este producto: ${producto.nombre} — ${url}`)
