...
import type { DirSwipeDescubri } from '@/pages/descubri/destinoDetalleDescubri'

const SWIPE_THRESHOLD = 90

type SwipeStamps = { like: string; skip: string }

type SwipeShellProps = {
  isTop: boolean
  stackIndex: number
  onSwipe: (dir: DirSwipeDescubri) => void
  stamps: SwipeStamps | null
  children: ReactNode
}
...
export default function SwipeShell({ isTop, stackIndex, onSwipe, stamps, children }: SwipeShellProps) {
