...
/** CTA de WhatsApp del menú móvil. */
export default function NavbarMobileWhatsApp() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <p className="text-sm font-semibold leading-tight">{t('nav.ayudaWa')}</p>
          <p className="text-xs opacity-70 mt-0.5">{t('nav.ayudaWaHorario')}</p>
        </div>
      </a>
    </motion.div>
  )
