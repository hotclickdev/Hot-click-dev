        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/", "/*.html", "/*.ico", "/*.jpg", "/*.jpeg", "/*.png",
                    ...
                    "/wishlist", "/blog", "/blog/**", "/emprendimientos",
            ...
            .headers(headers -> headers
                ...
                .addHeaderWriter((req, res) -> {
                    ...
                    res.setHeader("Content-Security-Policy",
                        ...
                        "script-src-elem 'self' https://js.stripe.com https://*.clerk.accounts.dev https://clerk.hotclick.lat https://www.googletagmanager.com https://www.google-analytics.com https://us-assets.i.posthog.com; " +
                        ...
                        "connect-src 'self' " + s3PublicUrl + " https://*.amazonaws.com https://*.clerk.accounts.dev https://clerk.hotclick.lat https://api.clerk.com https://clerk-telemetry.com https://api.stripe.com https://hooks.stripe.com https://www.google-analytics.com https://region1.google-analytics.com https://us.i.posthog.com https://us-assets.i.posthog.com https://*.ingest.us.sentry.io; " +
