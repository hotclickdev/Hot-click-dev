...
/**
 * Patrones y vocabulario del clasificador de consultas RAG.
 * Extraído bit-idéntico de QueryClassifier — no cambia comportamiento.
 */
final class QueryClassifierLexicon {

    // ── Prompt injection ──────────────────────────────────────────────────────

    static final List<Pattern> INJECTION_PATTERNS = List.of(
    ...
    static final Set<String> DOMAIN_KEYWORDS = Set.of(
        // Producto
    ...
    static final Set<String> COMPRA_KEYWORDS = Set.of(
    ...
    static final Set<String> SOPORTE_KEYWORDS = Set.of(
    ...
    static final List<Pattern> OOD_PATTERNS = List.of(
    ...
    static final Set<String> HARD_BLOCK_TERMS = Set.of(
    ...
    private QueryClassifierLexicon() {}
