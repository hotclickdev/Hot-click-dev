    ...
    static HeaderWriter create(String s3PublicUrl) {
        return (req, res) -> {
            ...
            res.setHeader("Content-Security-Policy",
                ...
                "frame-src https://js.stripe.com https://hooks.stripe.com https://app.tilopay.com https://secure.tilopay.com https://www.youtube.com https://www.youtube-nocookie.com https://www.tiktok.com https://www.instagram.com https://*.clerk.accounts.dev https://clerk.hotclick.lat; " +
