...
CREATE TABLE IF NOT EXISTS hot_click_empresa_feature_tb (fk_id_empresa BIGINT NOT NULL, fk_id_flag BIGINT NOT NULL, activo BOOLEAN NOT NULL DEFAULT TRUE, fecha_exp TIMESTAMP, PRIMARY KEY (fk_id_empresa, fk_id_flag));
