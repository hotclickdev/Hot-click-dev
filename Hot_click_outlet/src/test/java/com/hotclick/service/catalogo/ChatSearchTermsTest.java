...
class ChatSearchTermsTest {
    ...
    @Test
    @DisplayName("ILIKE une zapatos con zapatilla y tenis")
    void unionIlike_zapatosConSinonimos() {
        assertThat(ChatSearchTerms.unionIlike(List.of("zapatos"), List.of("zapatilla", "tenis")))
            .contains("zapatos", "zapatilla", "tenis");
    }
