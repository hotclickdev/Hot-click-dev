...
import com.hotclick.service.producto.ProductoDtoMapper;
import com.hotclick.service.producto.ProductoGuardadoNotifier;
...
/**
 * F35-04 — ProductoUpdater.actualizarProducto(): retry loop OptimisticLock.
 *
 * Verifica:
...
@DisplayName("F35-04 — ProductoUpdater: OptimisticLock retry (máx 3 intentos)")
class ProductoServiceOptimisticLockTest {
    ...
    @InjectMocks ProductoUpdater updater;
    ...
    void actualizar_noConflict_successIn1Try() {
        ...
        Producto result = updater.actualizarProducto(source, 1L, dto, "admin@test.cr");
    ...
    void actualizar_fail3Times_throwsRuntimeException() {
        ...
        assertThatThrownBy(() -> updater.actualizarProducto(source, 1L, dto, "admin@test.cr"))
    ...
    void actualizar_productoNotFound_throwsException() {
        ...
        assertThatThrownBy(() -> updater.actualizarProducto(source, 999L, dto, "admin@test.cr"))
            .isInstanceOf(RuntimeException.class)
    ...
    void actualizar_empresaIdReadOnceBeforeLoop() {
        ...
        updater.actualizarProducto(source, 1L, dto, "admin@test.cr");
